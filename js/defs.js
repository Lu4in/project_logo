...
let tovardata = [
    {
        id: 1,
        qty: 1,
        name: 'Процессор AMD A10 8770 PRO',
        image: '01.jpg',
        price: 5950,
    },   
    {
    ...
    },   
    {
        id: 2,
        qty: 10,
        name: 'Игра PS5 Resident Evil Village',
        image: '02.jpg',
        price: 4749,
    },
];
...
function makeOrder() {
    ...
    $.ajax({
        url: $('.forms form').prop('action'),
        method: $('.forms form').prop('method'),
        data: formdata,
...
function sliderRun(slideclass, direction) {
    ...
    $('.' + slideclass + '_block.curr').animate({left: next}, 2000, function() {
        $('.' + slideclass + '_block').eq(hlp).removeClass('curr').prop('style','');
        slideFlag[slideclass] = false;
    });
}
function retimer() {
